...
public class OPRoleDAOImpl implements OPRoleDAO {

    private static final Log log = LogFactory.getLog(OPRoleDAOImpl.class.getName());
    ...
    public int insert(OPRole obj) throws EduException
    {
        PreparedStatement pstmt = null;
        int result = 0;

        String sql = "INSERT INTO OPRole(RoleID,RoleName,OperID)VALUES(?,?,?)";
        ...
        try
        {
            ...
            PreparedStmtUtils.setString(pstmt,2,obj.RoleName);
        ...
        {
            String errorCode = ErrorCode.ERR_ADDOPROLEFAIL;
    ...
    public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException
    {
        ...
        SQLLog.logUpdate(log,"OPRole",setCols,whereCols);
        ...
        {
            String errorCode = ErrorCode.ERR_MODOPROLEFAIL;
            log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
            throw new EduException(errorCode);
        }
        finally
    ...
    public int delete(OPRole obj) throws EduException
    {
        PreparedStatement pstmt = null;
        int result = 0;

        String sql = "DELETE FROM OPRole WHERE RoleID = ? ";

        log.debug("[delete sql]:" + "DELETE FROM OPRole WHERE RoleID = " + obj.RoleID );
        ...
        {
            String errorCode = ErrorCode.ERR_DELOPROLEFAIL;
            log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
            throw new EduException(errorCode);
        }
        finally
    ...
    public int delete(JDBCFieldArray whereCols) throws EduException
    {
        ...
        String sql = "DELETE FROM OPRole WHERE 1=1 " ;
        ...
        SQLLog.logDelete(log,"OPRole",whereCols);
    ...
    public boolean isExist(OPRole obj) throws EduException
    {
        PreparedStatement pstmt = null;
        ResultSet rset = null;
        ...
        String sql = "SELECT COUNT(*) FROM OPRole WHERE RoleID = ? ";

        log.debug("[isExist sql]:" + "SELECT COUNT(*) FROM OPRole WHERE RoleID = " + obj.RoleID );
        ...
        {
            String errorCode = ErrorCode.ERR_QRYOPROLEFAIL;
            log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
            throw new EduException(errorCode);
        }
        finally
    ...
    public int isExist(JDBCFieldArray whereCols) throws EduException
    {
        ...
        String sql = "SELECT COUNT(*) FROM OPRole WHERE 1=1 " ;
        ...
        SQLLog.logIsExist(log,"OPRole",whereCols);
    ...
    public OPRole find(OPRole obj) throws EduException
    {
        OPRole result = null;
        PreparedStatement pstmt = null;
        ResultSet rset = null;

        String sql = "SELECT RoleID,RoleName,OperID  FROM OPRole WHERE RoleID = ? ";

        log.debug("[find sql]:" + "SELECT RoleID,RoleName,OperID  FROM OPRole WHERE RoleID = " + obj.RoleID );
        ...
        try
        {
            ...
            if(rset.next() == true)
            {
                ...
                result.RoleName = rset.getString(2);
    ...
    public RowSet select(JDBCFieldArray whereCols) throws EduException
    {
        ...
        String sql = "SELECT * FROM OPRole WHERE 1=1 ";
    ...
    public String selectFunctions(String fName,JDBCFieldArray whereCols) throws EduException
    {
        ...
        String sql = "SELECT " + fName + " FROM OPRole WHERE 1=1 ";

...
public class OPRoleSpeRightDAOImpl implements OPRoleSpeRightDAO {

    private static final Log log = LogFactory.getLog(OPRoleSpeRightDAOImpl.class.getName());
    ...
    public int insert(OPRoleSpeRight obj) throws EduException
    {
        ...
        String sql = "INSERT INTO OPRoleSpeRight(SpePrivID,RoleID)VALUES(?,?)";
        ...
        {
            String errorCode = ErrorCode.ERR_ADDOPROLESPERIGHTFAIL;
    ...
    public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException
    {
        ...
        String sql = "UPDATE OPRoleSpeRight SET ";
        ...
        SQLLog.logUpdate(log,"OPRoleSpeRight",setCols,whereCols);
        ...
        {
            String errorCode = ErrorCode.ERR_MODOPROLESPERIGHTFAIL;
            log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
            throw new EduException(errorCode);
        }
        finally
    ...
    public int delete(OPRoleSpeRight obj) throws EduException
    {
        ...
        String sql = "DELETE FROM OPRoleSpeRight WHERE SpePrivID = ?  AND RoleID = ? ";

        log.debug("[delete sql]:" + "DELETE FROM OPRoleSpeRight WHERE SpePrivID = " + obj.SpePrivID +
        ...
        {
            String errorCode = ErrorCode.ERR_DELOPROLESPERIGHTFAIL;
            log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
            throw new EduException(errorCode);
        }
        finally
    ...
    public int delete(JDBCFieldArray whereCols) throws EduException
    {
        ...
        String sql = "DELETE FROM OPRoleSpeRight WHERE 1=1 " ;
        ...
        SQLLog.logDelete(log,"OPRoleSpeRight",whereCols);
    ...
    public boolean isExist(OPRoleSpeRight obj) throws EduException
    {
        ...
        String sql = "SELECT COUNT(*) FROM OPRoleSpeRight WHERE SpePrivID = ?  AND RoleID = ? ";

        log.debug("[isExist sql]:" + "SELECT COUNT(*) FROM OPRoleSpeRight WHERE SpePrivID = " + obj.SpePrivID +
                        " AND RoleID = " + obj.RoleID );
        ...
        {
            String errorCode = ErrorCode.ERR_QRYOPROLESPERIGHTFAIL;
            log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
            throw new EduException(errorCode);
        }
        finally
    ...
    public int isExist(JDBCFieldArray whereCols) throws EduException
    {
        ...
        String sql = "SELECT COUNT(*) FROM OPRoleSpeRight WHERE 1=1 " ;
        ...
        SQLLog.logIsExist(log,"OPRoleSpeRight",whereCols);
    ...
    {
        OPRoleSpeRight result = null;
        PreparedStatement pstmt = null;
        ResultSet rset = null;

        String sql = "SELECT SpePrivID,RoleID  FROM OPRoleSpeRight WHERE SpePrivID = ?  AND RoleID = ? ";

        log.debug("[find sql]:" + "SELECT SpePrivID,RoleID  FROM OPRoleSpeRight WHERE SpePrivID = " + obj.SpePrivID +
                        " AND RoleID = " + obj.RoleID );
        ...
        try
        {
            ...
            {
                throw new EduException(ErrorCode.ERR_OPROLESPERIGHTNODATA);
            }
        }
        catch(SQLException e)
        {
    ...
    public RowSet select(JDBCFieldArray whereCols) throws EduException
    {
        ...
        String sql = "SELECT * FROM OPRoleSpeRight WHERE 1=1 ";
    ...
    public String selectFunctions(String fName,JDBCFieldArray whereCols) throws EduException
    {
        ...
        String sql = "SELECT " + fName + " FROM OPRoleSpeRight WHERE 1=1 ";

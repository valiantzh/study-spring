...
public class OPOperSpeRightDAOImpl implements OPOperSpeRightDAO {

    private static final Log log = LogFactory.getLog(OPOperSpeRightDAOImpl.class.getName());
    ...
    public int insert(OPOperSpeRight obj) throws EduException
    {
        PreparedStatement pstmt = null;
        int result = 0;

        String sql = "INSERT INTO OPOperSpeRight(OperID,SpePrivID)VALUES(?,?)";
        ...
        try
        {
            ...
            PreparedStmtUtils.setInt(pstmt,2,obj.SpePrivID);
            result = pstmt.executeUpdate();

        }
        catch(SQLException e)
        {
            String errorCode = ErrorCode.ERR_ADDOPOPERSPERIGHTFAIL;
    ...
    public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException
    {
        ...
        String sql = "UPDATE OPOperSpeRight SET ";
        ...
        SQLLog.logUpdate(log,"OPOperSpeRight",setCols,whereCols);
        ...
        {
            String errorCode = ErrorCode.ERR_MODOPOPERSPERIGHTFAIL;
            log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
            throw new EduException(errorCode);
        }
        finally
    ...
    public int delete(OPOperSpeRight obj) throws EduException
    {
        PreparedStatement pstmt = null;
        int result = 0;

        String sql = "DELETE FROM OPOperSpeRight WHERE OperID = ?  AND SpePrivID = ? ";

        log.debug("[delete sql]:" + "DELETE FROM OPOperSpeRight WHERE OperID = " + StringUtils.addQuote(obj.OperID) +
                        " AND SpePrivID = " + obj.SpePrivID );
        ...
        {
            String errorCode = ErrorCode.ERR_DELOPOPERSPERIGHTFAIL;
            log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
            throw new EduException(errorCode);
        }
        finally
    ...
    public int delete(JDBCFieldArray whereCols) throws EduException
    {
        ...
        String sql = "DELETE FROM OPOperSpeRight WHERE 1=1 " ;
        ...
        SQLLog.logDelete(log,"OPOperSpeRight",whereCols);
    ...
    public boolean isExist(OPOperSpeRight obj) throws EduException
    {
        PreparedStatement pstmt = null;
        ResultSet rset = null;
        ...
        String sql = "SELECT COUNT(*) FROM OPOperSpeRight WHERE OperID = ?  AND SpePrivID = ? ";

        log.debug("[isExist sql]:" + "SELECT COUNT(*) FROM OPOperSpeRight WHERE OperID = " + StringUtils.addQuote(obj.OperID) +
                        " AND SpePrivID = " + obj.SpePrivID );
        ...
        {
            String errorCode = ErrorCode.ERR_QRYOPOPERSPERIGHTFAIL;
            log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
            throw new EduException(errorCode);
        }
        finally
    ...
    public int isExist(JDBCFieldArray whereCols) throws EduException
    {
        ...
        String sql = "SELECT COUNT(*) FROM OPOperSpeRight WHERE 1=1 " ;
        ...
        SQLLog.logIsExist(log,"OPOperSpeRight",whereCols);
    ...
    public OPOperSpeRight find(OPOperSpeRight obj) throws EduException
    {
        OPOperSpeRight result = null;
        PreparedStatement pstmt = null;
        ResultSet rset = null;

        String sql = "SELECT OperID,SpePrivID  FROM OPOperSpeRight WHERE OperID = ?  AND SpePrivID = ? ";

        log.debug("[find sql]:" + "SELECT OperID,SpePrivID  FROM OPOperSpeRight WHERE OperID = " + StringUtils.addQuote(obj.OperID) +
                        " AND SpePrivID = " + obj.SpePrivID );
        ...
        try
        {
            ...
            if(rset.next() == true)
            {
                result = new OPOperSpeRight();
                result.OperID = rset.getString(1);
                result.SpePrivID = rset.getInt(2);

            }
            else
            {
                throw new EduException(ErrorCode.ERR_OPOPERSPERIGHTNODATA);
            }
        }
        catch(SQLException e)
        {
    ...
    public RowSet select(JDBCFieldArray whereCols) throws EduException
    {
        ...
        String sql = "SELECT * FROM OPOperSpeRight WHERE 1=1 ";
    ...
    public String selectFunctions(String fName,JDBCFieldArray whereCols) throws EduException
    {
        ...
        String sql = "SELECT " + fName + " FROM OPOperSpeRight WHERE 1=1 ";

...
public class OPSpecialPrivDAOImpl implements OPSpecialPrivDAO {

    private static final Log log = LogFactory.getLog(OPSpecialPrivDAOImpl.class.getName());
    ...
    public int insert(OPSpecialPriv obj) throws EduException
    {
        PreparedStatement pstmt = null;
        int result = 0;

        String sql = "INSERT INTO OPSpecialPriv(SpePrivID,SpePrivName)VALUES(?,?)";
        ...
        try
        {
            ...
            PreparedStmtUtils.setInt(pstmt,1,obj.SpePrivID);
            PreparedStmtUtils.setString(pstmt,2,obj.SpePrivName);
            result = pstmt.executeUpdate();

        }
        catch(SQLException e)
        {
            String errorCode = ErrorCode.ERR_ADDOPSPECIALPRIVFAIL;
    ...
    public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException
    {
        ...
        String sql = "UPDATE OPSpecialPriv SET ";
        ...
        SQLLog.logUpdate(log,"OPSpecialPriv",setCols,whereCols);
        ...
        {
            String errorCode = ErrorCode.ERR_MODOPSPECIALPRIVFAIL;
            log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
            throw new EduException(errorCode);
        }
        finally
    ...
    public int delete(OPSpecialPriv obj) throws EduException
    {
        PreparedStatement pstmt = null;
        int result = 0;

        String sql = "DELETE FROM OPSpecialPriv WHERE SpePrivID = ? ";

        log.debug("[delete sql]:" + "DELETE FROM OPSpecialPriv WHERE SpePrivID = " + obj.SpePrivID );
        ...
        {
            String errorCode = ErrorCode.ERR_DELOPSPECIALPRIVFAIL;
            log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
            throw new EduException(errorCode);
        }
        finally
    ...
    public int delete(JDBCFieldArray whereCols) throws EduException
    {
        ...
        String sql = "DELETE FROM OPSpecialPriv WHERE 1=1 " ;
        ...
        SQLLog.logDelete(log,"OPSpecialPriv",whereCols);
    ...
    public boolean isExist(OPSpecialPriv obj) throws EduException
    {
        PreparedStatement pstmt = null;
        ResultSet rset = null;
        ...
        String sql = "SELECT COUNT(*) FROM OPSpecialPriv WHERE SpePrivID = ? ";

        log.debug("[isExist sql]:" + "SELECT COUNT(*) FROM OPSpecialPriv WHERE SpePrivID = " + obj.SpePrivID );
        ...
        {
            String errorCode = ErrorCode.ERR_QRYOPSPECIALPRIVFAIL;
            log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
            throw new EduException(errorCode);
        }
        finally
    ...
    public int isExist(JDBCFieldArray whereCols) throws EduException
    {
        ...
        String sql = "SELECT COUNT(*) FROM OPSpecialPriv WHERE 1=1 " ;
        ...
        SQLLog.logIsExist(log,"OPSpecialPriv",whereCols);
    ...
    public OPSpecialPriv find(OPSpecialPriv obj) throws EduException
    {
        OPSpecialPriv result = null;
        PreparedStatement pstmt = null;
        ResultSet rset = null;

        String sql = "SELECT SpePrivID,SpePrivName  FROM OPSpecialPriv WHERE SpePrivID = ? ";

        log.debug("[find sql]:" + "SELECT SpePrivID,SpePrivName  FROM OPSpecialPriv WHERE SpePrivID = " + obj.SpePrivID );
        ...
        try
        {
            ...
            if(rset.next() == true)
            {
                result = new OPSpecialPriv();
                result.SpePrivID = rset.getInt(1);
                result.SpePrivName = rset.getString(2);

            }
            else
            {
                throw new EduException(ErrorCode.ERR_OPSPECIALPRIVNODATA);
            }
        }
        catch(SQLException e)
        {
    ...
    public RowSet select(JDBCFieldArray whereCols) throws EduException
    {
        ...
        String sql = "SELECT * FROM OPSpecialPriv WHERE 1=1 ";
    ...
    public String selectFunctions(String fName,JDBCFieldArray whereCols) throws EduException
    {
        ...
        String sql = "SELECT " + fName + " FROM OPSpecialPriv WHERE 1=1 ";

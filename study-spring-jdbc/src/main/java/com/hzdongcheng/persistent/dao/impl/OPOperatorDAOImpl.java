...
public class OPOperatorDAOImpl implements OPOperatorDAO {

    private static final Log log = LogFactory.getLog(OPOperatorDAOImpl.class.getName());
    ...
    public int insert(OPOperator obj) throws EduException
    {
        PreparedStatement pstmt = null;
        int result = 0;

        String sql = "INSERT INTO OPOperator(OperID,DepartmentID,UserID,OperType,OperName,OperPassword,PlainPassword,BindCardID,BindMobile,OfficeTel,Mobile,Email,CreateDate,CreateTime,UpperUserID,OperStatus,LastModifyTime,Remark)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        ...
        try
        {
            ...
            PreparedStmtUtils.setString(pstmt,5,obj.OperName);
            PreparedStmtUtils.setString(pstmt,6,obj.OperPassword);
            PreparedStmtUtils.setString(pstmt,7,obj.PlainPassword);
            PreparedStmtUtils.setString(pstmt,8,obj.BindCardID);
            PreparedStmtUtils.setString(pstmt,9,obj.BindMobile);
            PreparedStmtUtils.setString(pstmt,10,obj.OfficeTel);
            PreparedStmtUtils.setString(pstmt,11,obj.Mobile);
            PreparedStmtUtils.setString(pstmt,12,obj.Email);
            PreparedStmtUtils.setDate(pstmt,13,obj.CreateDate);
            PreparedStmtUtils.setTimestamp(pstmt,14,obj.CreateTime);
            PreparedStmtUtils.setString(pstmt,15,obj.UpperUserID);
            PreparedStmtUtils.setString(pstmt,16,obj.OperStatus);
        ...
        {
            String errorCode = ErrorCode.ERR_ADDOPOPERATORFAIL;
    ...
    public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException
    {
        ...
        String sql = "UPDATE OPOperator SET ";
        ...
        SQLLog.logUpdate(log,"OPOperator",setCols,whereCols);
        ...
        {
            String errorCode = ErrorCode.ERR_MODOPOPERATORFAIL;
            log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
            throw new EduException(errorCode);
        }
        finally
    ...
    public int delete(OPOperator obj) throws EduException
    {
        PreparedStatement pstmt = null;
        int result = 0;

        String sql = "DELETE FROM OPOperator WHERE OperID = ? ";

        log.debug("[delete sql]:" + "DELETE FROM OPOperator WHERE OperID = " + StringUtils.addQuote(obj.OperID) );
        ...
        {
            String errorCode = ErrorCode.ERR_DELOPOPERATORFAIL;
            log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
            throw new EduException(errorCode);
        }
        finally
    ...
    public int delete(JDBCFieldArray whereCols) throws EduException
    {
        ...
        String sql = "DELETE FROM OPOperator WHERE 1=1 " ;
        ...
        SQLLog.logDelete(log,"OPOperator",whereCols);
    ...
    public boolean isExist(OPOperator obj) throws EduException
    {
        PreparedStatement pstmt = null;
        ResultSet rset = null;
        ...
        String sql = "SELECT COUNT(*) FROM OPOperator WHERE OperID = ? ";

        log.debug("[isExist sql]:" + "SELECT COUNT(*) FROM OPOperator WHERE OperID = " + StringUtils.addQuote(obj.OperID) );
        ...
        {
            String errorCode = ErrorCode.ERR_QRYOPOPERATORFAIL;
            log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
            throw new EduException(errorCode);
        }
        finally
    ...
    public int isExist(JDBCFieldArray whereCols) throws EduException
    {
        ...
        String sql = "SELECT COUNT(*) FROM OPOperator WHERE 1=1 " ;
        ...
        SQLLog.logIsExist(log,"OPOperator",whereCols);
    ...
    public OPOperator find(OPOperator obj) throws EduException
    {
        OPOperator result = null;
        PreparedStatement pstmt = null;
        ResultSet rset = null;

        String sql = "SELECT OperID,DepartmentID,UserID,OperType,OperName,OperPassword,PlainPassword,BindCardID,BindMobile,OfficeTel,Mobile,Email,CreateDate,CreateTime,UpperUserID,OperStatus,LastModifyTime,Remark  FROM OPOperator WHERE OperID = ? ";

        log.debug("[find sql]:" + "SELECT OperID,DepartmentID,UserID,OperType,OperName,OperPassword,PlainPassword,BindCardID,BindMobile,OfficeTel,Mobile,Email,CreateDate,CreateTime,UpperUserID,OperStatus,LastModifyTime,Remark  FROM OPOperator WHERE OperID = " + StringUtils.addQuote(obj.OperID) );
        ...
        try
        {
            ...
            if(rset.next() == true)
            {
                ...
                result.OperName = rset.getString(5);
                result.OperPassword = rset.getString(6);
                result.PlainPassword = rset.getString(7);
                result.BindCardID = rset.getString(8);
                result.BindMobile = rset.getString(9);
                result.OfficeTel = rset.getString(10);
                result.Mobile = rset.getString(11);
                result.Email = rset.getString(12);
                result.CreateDate = rset.getDate(13);
                result.CreateTime = rset.getTimestamp(14);
                result.UpperUserID = rset.getString(15);
                result.OperStatus = rset.getString(16);
    ...
    public RowSet select(JDBCFieldArray whereCols) throws EduException
    {
        ...
        String sql = "SELECT * FROM OPOperator WHERE 1=1 ";
    ...
    public String selectFunctions(String fName,JDBCFieldArray whereCols) throws EduException
    {
        ...
        String sql = "SELECT " + fName + " FROM OPOperator WHERE 1=1 ";
